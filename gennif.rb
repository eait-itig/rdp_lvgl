...
LvFunc.new('group_focus_prev', Void, Group.new('group'))
LvFunc.new('group_set_wrap', Void, Group.new('group'), Bool8.new('wrap'))
LvFunc.new('group_focus_freeze', Void, Group.new('group'), Bool8.new('freeze'))
